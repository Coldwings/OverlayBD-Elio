...
| `tryCnt` | uint32, minimum `1` | `5` | Completion-verify attempts before giving up (a failed sha256 verification discards the staging pair and restarts); `0` is a structural configuration error. |
